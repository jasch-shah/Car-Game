...
def playersHasHitBaddie(playerRect, baddies):
	for b in baddies:
...
# the game loop
	while True:
        ...
        if playersHasHitBaddie(playerRect, baddies):
        	if score > topScore:
    ...
    if (count == 0):
      ...
      drawText('Press key to play again.', font, windowSurface, (WINDOWWIDTH / 3) - 80, (WINDOWHEIGHT / 3) + 30)
      pygame.display.update()
      time.sleep(2)
      waitForPlayerToPressKey()
      count=3
